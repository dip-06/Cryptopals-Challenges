...
The base64 alphabet formation: Used string library to create the list. The list is made according to base64 alphabet that is A-Z,a-z,0-9,+,/ . Where index of A is 0.
